        ...
        <div className='main-container'>
            ...
            <div className='d-flex justify-content-center'>
                <div>
                    ...
                    <div className='mt-2'>
                        <h5 className='text-center mb-3'>Do you know the requirement for this disease?</h5>
                    ...
                    {requirementKnown === 'No' &&
                        excelData.filter(row => row.Problem === selectedProblem.problem)
                            .map(row => (
                    ...
                    <div className='mt-4'>
                        ...
                        <Dropdown className='text-center' onSelect={handleRequirementSelect} style={{ whiteSpace: 'normal', wordWrap: 'break-word' }}>
                            ...
                            <Dropdown.Menu className='text-center m-100 max-width'>
                                ...
                                {requirementKnown === 'Yes' && selectedProblem.problem && excelData.filter((row, index) => index === selectedProblem.index)
                                    .map((row) => (
                                        row.Requirement && (
                                            <Dropdown.Item
                                                key={row.Requirement}
                    ...
                    <div className='mt-4'>
                        ...
                        <Dropdown className='text-center' onSelect={handleDifferentiationSelect}>
                            ...
                            <Dropdown.Menu className='text-center m-100 max-width'>
                                ...
                                {requirementKnown === 'Yes' && selectedResult.result &&
                                    excelData
                                        .slice(selectedResult.index)
                                        .reduce((acc, row, index, array) => {
                                            if ((row['Result of Requirement '] === selectedResult.result) || row['Result of Requirement '] === "") {
                    ...
                    <div className='mt-4'>
                        ...
                        <Dropdown className='text-center' onSelect={handleReasonSelect}>
                            ...
                            <Dropdown.Menu className='text-center m-100 max-width'>
                                ...
                                {requirementKnown === 'Yes' && selectedResult.result && selectedDifferentiation.differentiation ? excelData.filter((row, index) => index === selectedDifferentiation.index)
                                    .map((row, index) => (
                                        <Dropdown.Item
                                            key={index}
                                            eventKey={row['Reason for Problem ']}
                    ...
                    <div className='mt-4'>
                        ...
                        <Dropdown className='text-center' onSelect={handleSolutionSelect}>
                            ...
                            <Dropdown.Menu className='text-center m-100 max-width'>
                                ...
                                {requirementKnown === 'Yes' && selectedResult.result && selectedReason.reason ?
                                    excelData
